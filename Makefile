...
YFS_OBJS = $(SRC_DIR)/yfs.o $(SRC_DIR)/yfscall.o $(SRC_DIR)/fscache.o $(SRC_DIR)/hashtable.o
YFS_SRCS = $(SRC_DIR)/yfs.c $(SRC_DIR)/yfscall.c $(SRC_DIR)/fscache.c $(SRC_DIR)/hashtable.c
